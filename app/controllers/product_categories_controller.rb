class ProductCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product_category.save
        format.html do
          flash[:notice] = 'New product category added!'
        ...
        format.html do
          flash[:error] = 'Error creating the new product category!'
          render :new
        end
  ...
  def product_category_params
    params.require(:product_category).permit(:name, :parent_category_id)
  end
end
