...
ActiveRecord::Schema.define(version: 20160112045838) do
  ...
  add_index "product_categories", ["parent_category_id"], name: "index_product_categories_on_parent_category_id"
