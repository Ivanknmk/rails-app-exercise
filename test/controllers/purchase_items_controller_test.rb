...
class PurchaseItemsControllerTest < ActionController::TestCase
  ...
  test "should create purchase_item" do
    assert_difference('PurchaseItem.count') do
      post :create, purchase_item: { amount: @purchase_item.amount, product: @purchase_item.product, purchase_id: @purchase_item.purchase_id, references: @purchase_item.references }
    end
  ...
  test "should update purchase_item" do
    patch :update, id: @purchase_item, purchase_item: { amount: @purchase_item.amount, product: @purchase_item.product, purchase_id: @purchase_item.purchase_id, references: @purchase_item.references }
    assert_redirected_to purchase_item_path(assigns(:purchase_item))
  end
